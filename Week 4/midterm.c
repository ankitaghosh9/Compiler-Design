...
const char *keywords[] = {"class","concat"};
const char *datypes[]={"int","String"};
...
int main()
{
	FILE *fa, *fb;
    int ca, cb;
    fa = fopen("/home/Student/Desktop/AnkitaGhosh_CD/Week 4/inputm.c", "r");
    if (fa == NULL){
        printf("Cannot open file \n");
        exit(0);
    }

    fb = fopen("/home/Student/Desktop/AnkitaGhosh_CD/Week 4/output.c", "w+");
    ca = getc(fa);
	while (ca != EOF){
		if(ca==' ')
		{
	...
	fclose(fa);
	fclose(fb);
	fa = fopen("/home/Student/Desktop/AnkitaGhosh_CD/Week 4/output.c", "r");
	if(fa == NULL){
		printf("Cannot open file");
		return 0;
	}
	...
	fclose(fb);
	remove("temp.c");
	FILE *f1=fopen("/home/Student/Desktop/AnkitaGhosh_CD/Week 4/output.c","r");
	if(f1==NULL)
	{
